...
public class AutoWeatherClearOnOffCommandCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("autoweatherclear")
				...
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
					...
					AutoWeatherClearOnOffProcedureProcedure.executeProcedure(
