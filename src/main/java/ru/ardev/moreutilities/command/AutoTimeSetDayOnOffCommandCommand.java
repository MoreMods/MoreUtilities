...
public class AutoTimeSetDayOnOffCommandCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("autotimesetday")
				...
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
					...
					AutoTimeSetDayOnOffProcedureProcedure.executeProcedure(
